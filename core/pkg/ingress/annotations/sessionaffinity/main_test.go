...
func TestIngressAffinityCookieConfig(t *testing.T) {
	...
	data[annotationAffinityCookieFlags] = "secure"
	...
	if nginxAffinity.CookieConfig.Flags != "secure" {
		t.Errorf("expected secure as cookie flags but returned %v", nginxAffinity.CookieConfig.Flags)
	}
}
